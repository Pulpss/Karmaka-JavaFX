...
/**
 * La classe {@code Main} représente le point d'entrée principal de l'application Karmaka.
 * Elle étend la classe {@code Application} de JavaFX et initialise le routeur de l'interface utilisateur.
 * La scène initiale est définie sur le menu principal.
 *
 * <p>Pour lancer l'application, la méthode statique {@code main} est utilisée pour appeler la méthode {@code launch} de JavaFX.</p>
 */
public class Main extends Application {
    /**
     * Méthode appelée lors du démarrage de l'application JavaFX.
     * Initialise le routeur de l'interface utilisateur et définit la scène initiale sur le menu principal.
     *
