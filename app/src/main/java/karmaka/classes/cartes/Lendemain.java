...
/**
 * La classe Lendemain représente une carte du jeu Karmaka avec le pouvoir spécifique "Puisez une carte à la Source. Vous pouvez ensuite jouer une autre carte.".
 */
