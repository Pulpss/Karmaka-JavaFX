...
/**
 * La classe CoupDoeil représente une carte du jeu Karmaka avec le pouvoir spécifique "Regardez la Main d’un rival. Vous pouvez ensuite jouer une autre carte.".
 */
