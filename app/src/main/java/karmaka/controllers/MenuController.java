...
/**
 * La classe MenuController gère les actions et les interactions de l'interface utilisateur
 * pour le menu principal du jeu.
 */
public class MenuController implements Initializable {
	
	/**
     * Gère l'action du bouton "Jouer" pour rediriger vers la scène de création de partie.
     */
    @FXML
    ...
    /**
     * Gère l'action du bouton "Charger" pour initialiser une partie, charger une sauvegarde
