 ...
 * Elle hérite de la classe {@code Joueur} et implémente les méthodes spécifiques aux interactions d'un joueur humain.
 *
 * <p>Cette classe utilise le gestionnaire de routage {@code Router} pour gérer les interactions utilisateur.</p>
 */
