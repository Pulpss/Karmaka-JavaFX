...
public class Oeuvres extends Pile {
     ...
     * Les points sont attribués en fonction de la couleur des cartes et de leurs valeurs.
     * Les couleurs sont représentées par des constantes : 0 pour Rouge, 1 pour Vert, 2 pour Bleu, 3 pour Mosaique.
     * Les points sont cumulés par couleur et on conserve celle ayant accumulé le plus de points.
     * On note ce résultat et on y ajoutant les points de la couleur Mosaique. Ce résultat correspond aux points obtenus par le joueur.
     *
