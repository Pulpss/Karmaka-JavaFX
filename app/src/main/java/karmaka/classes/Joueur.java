...
/**
 * La classe abstraite Joueur représente un joueur durant une partie de jeu Karmaka.
 * Chaque joueur possède un nom, une échelle karmique, un nombre d'anneaux karmiques, une main de cartes, un deck, une pile "Vie future", et une pile "Oeuvres".
 * La classe est conçue pour être étendue par des classes spécifiques de joueurs, tels que des joueurs humains ou des robots.
 * Elle implémente l'interface Serializable pour permettre la sérialisation des instances de joueurs.
 *
 * @see Serializable
 */
public abstract class Joueur implements Serializable {
     ...
     * Les sous-classes de Joueur devront implémenter cette méthode pour définir le comportement spécifique du choix de carte par le joueur.
     *
     ...
     * Les sous-classes de Joueur devront implémenter cette méthode pour définir le comportement spécifique du choix d'option par le joueur.
     *
     ...
     * Les sous-classes de Joueur devront implémenter cette méthode pour définir le comportement spécifique de l'affichage des cartes par le joueur.
     *
     ...
     * Les sous-classes de Joueur devront implémenter cette méthode pour définir le comportement spécifique de l'affichage des messages par le joueur.
     *
     ...
     * Les sous-classes de Joueur devront implémenter cette méthode pour définir si le joueur est un robot ou non.
     *
